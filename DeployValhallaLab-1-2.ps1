...
try {
    ...
    Set-DNSClientServerAddress –InterfaceIndex (Get-NetAdapter).InterfaceIndex –ServerAddresses (127.0.0.1,$natdns)
...
#Create SecureString for password
    $securePass = (ConvertTo-SecureString -String $DSRMPASS -AsPlainText -Force)
